...
// Column headers.
const columns = [
    { key: 'Title', name: 'Request No.', fieldName: 'Title', minWidth: 100, maxWidth: 200, isResizable: true },
    { key: 'RequestTitle', name: 'Request Title', fieldName: 'RequestTitle', minWidth: 100, maxWidth: 200, isResizable: true },
    { key: 'RequestStatus', name: 'Request Status', fieldName: 'RequestStatus', minWidth: 100, maxWidth: 200, isResizable: true }
];
